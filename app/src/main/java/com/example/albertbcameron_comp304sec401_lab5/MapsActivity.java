...
import com.example.albertbcameron_comp304sec401_lab5.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (extras != null)
        {
            selectedRestaurantId = extras.getString("selectedRestaurantId");
            if (selectedRestaurantId.length() > 0) {
                restaurant = RestaurantStaticDataList.getRestaurantByRestaurantId(selectedRestaurantId);
